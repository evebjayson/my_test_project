...
class MyHttpservice(object):
    ...
    def post(self,url,**kwargs):
        ...
        try:
            res = self.driver(url,params=params,data=data,json=json,files=files,headers=header)
...
#
#     def __init__(self):
#         self.route = "/api/Account/Login"
#         self.url = "".join(base.get_url(self.route))
#     def get_session(self):
#         self.s = requests.Session()
#         s = self.s.post( self.url)
#
#         return s
